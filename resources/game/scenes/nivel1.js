...
export default class nivel1 extends Phaser.Scene{
    ...
    {   
        ...
        this.load.image('final', 'game/assets/final.png');
        ...
        //Audio
        this.load.audio('salto', 'game/assets/salto.wav');
        this.load.audio('musica', 'game/assets/musica.mp3');    
        this.load.audio('monedas', 'game/assets/monedas.mp3');    
