...
export class nivel3 extends Phaser.Scene{
    ...
    preload ()
    {   
        this.load.image('sky3', 'js/game/assets/sky.png');
        this.load.image('ground3', 'js/game/assets/platform1.png');
        this.load.image('star', 'js/game/assets/star.png');
        this.load.image('bomb', 'js/game/assets/bomb.png');
        this.load.image('background1', 'js/game/assets/first.png');
        this.load.image('background2', 'js/game/assets/forest.png');
        this.load.image('final', 'js/game/assets/final.png');
        this.load.spritesheet('dude', 'js/game/assets/dude2.png', { frameWidth: 32, frameHeight: 48 });
        this.load.spritesheet('dude2', 'js/game/assets/marioSmall.png', { frameWidth: 34, frameHeight: 34 });
    }
