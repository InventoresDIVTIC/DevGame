...
export class nivel1 extends Phaser.Scene{
    ...
    preload ()
    {   
        this.load.image('sky', 'js/game/assets/forest.png');
        this.load.image('ground', 'js/game/assets/platform.png');
        this.load.image('star', 'js/game/assets/star.png');
        this.load.image('bomb', 'js/game/assets/bomb.png');
        // this.load.image('background1', 'js/game/assets/background_layer_1.png')
        // this.load.image('background2', 'js/game/assets/forest.png')
        this.load.image('final', 'js/game/assets/final.png');
        this.load.spritesheet('dude', 'js/game/assets/dude.png', { frameWidth: 32, frameHeight: 48 });
        this.load.spritesheet('dude2', 'js/game/assets/dude2.png', { frameWidth: 32, frameHeight: 48 });
        //Audio
        this.load.audio('salto', 'js/game/assets/salto.wav');
        this.load.audio('musica', 'js/game/assets/musica.mp3');    
        this.load.audio('monedas', 'js/game/assets/monedas.mp3');    
